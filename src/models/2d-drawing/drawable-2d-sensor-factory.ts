...
export class Drawable2DSensorFactory extends SensorFactory
{
    ...
    create(type: string, environment: Environment, parent: BasicObject): Sensor
    {
        switch(type)
        {
            case 'compass': return new Drawable2DCompass("Compass", environment, parent); break;
            case 'ultrasound': return new Drawable2DUltrasound("Ultrasound", environment, parent); break;
